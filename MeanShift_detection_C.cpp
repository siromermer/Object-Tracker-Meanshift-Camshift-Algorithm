...
void track_object(const std::vector<int>& first_range, const std::vector<int>& second_range)
{
    ...
    cout << "inside of track_object" << endl;
    ...
    cv::VideoCapture capture("C:/Libraries/ObjectDetection/src/fish.mp4");
...
void extract_color(int& width, int& height)
{
    ...
    cout << "Inside of extract_color asd function" << endl;
    cout << width << endl;
    cout << height << endl;
...
cv::VideoCapture video("C:/Libraries/ObjectDetection/src/fish.mp4");
...
int main() {
    ...
    cout << (center_points[0]) << endl;
    cout << (center_points[1]) << endl;
